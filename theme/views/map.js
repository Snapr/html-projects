...
var map_view = page_view.extend({
    ...
    post_initialize: function(){
        ...
        //line changed:
        this.thumb_template = this.get_template('../../theme/templates/image');
    ...
    photo_query_save: function(){
        local_storage.set('map_photo_params', _(this.photo_query.attributes).pick(['date', 'keywords', 'username', 'group', 'photo_id']));
    },
